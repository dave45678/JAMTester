...
public class StudentToolAboutDialog
extends JDialog {
    Image img = null;
    public static String versionID = "v1.30.011306";
    ImageObserver imgobs;

    public StudentToolAboutDialog(Frame frame) {
        super(frame, "About JAM*Tester Student Version " + versionID + "...");
        this.imgobs = this;
        try {
            this.img = ImageIO.read(new File("StudentVersion.jpg"));
        }
        ...
        StudentToolAboutDialog.centerWindow(this);
    ...
    private void prepImg(Graphics graphics) {
        ...
        graphics.drawString(versionID, 20, 20);
    }
