...
import org.jext.xml.PyActionsHandler;
...
public class PyActionsReader {
    public static boolean read(InputStream inputStream, String string) {
        ...
        xmlParser.setHandler((XmlHandler)new PyActionsHandler());
        try {
            Class class_ = Jext.class;
            xmlParser.parse(class_.getResource("pyactions.dtd").toString(), null, (Reader)inputStreamReader);
        }
        catch (XmlException var5_5) {
            System.err.println("PyActions: Error parsing grammar " + inputStream);
            System.err.println("PyActions: Error occured at line " + var5_5.getLine() + ", column " + var5_5.getColumn());
            System.err.println("PyActions: " + var5_5.getMessage());
            return false;
        }
