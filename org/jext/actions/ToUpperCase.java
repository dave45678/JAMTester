...
implements EditAction {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        JextTextArea jextTextArea = ToUpperCase.getTextArea(actionEvent);
        jextTextArea.beginCompoundEdit();
        String string = jextTextArea.getSelectedText();
        if (string != null) {
            jextTextArea.setSelectedText(string.toUpperCase());
        } else {
            ...
            try {
                ...
                syntaxDocument.insertString(n, new StringBuffer(1).append(c).toString().toUpperCase(), null);
